...
window.addEventListener('DOMContentLoaded', function () {
  ...
  function setupVideo(video) {
    ...
    var href = link.href.slice(32);
    button.addEventListener('click', function () {
      var iframe = createIframe(href);
      link.remove();
      button.remove();
  ...
  var tabs = document.querySelector('[data-tab="container"]');

  var removeTriggerActive = function removeTriggerActive() {
    document.querySelectorAll('[data-tab="trigger"]').forEach(function (child) {
      return child.classList.remove('tabs__trigger--active');
    });
  };

  var removeContentActive = function removeContentActive() {
    document.querySelectorAll('[data-tab="content"]').forEach(function (child) {
      return child.classList.remove('tabs__content--active');
    });
  };

  if (tabs) {
    var firstTab = tabs.querySelector('[data-tab="trigger"]');
    tabs.querySelectorAll('[data-tab="trigger"]').forEach(function (item) {
  ...
  var lessonForm = document.querySelector('[data-form="free-lesson"]');

  if (lessonForm) {
    var feedbackName = document.querySelector('[data-input="name"]');
    var feedbackPhone = document.querySelector('[data-input="phone"]');
    var feedbackInputs = [feedbackName, feedbackPhone];
    var feedbackSubmit = document.querySelector('[data-input="submit"]');

    var changeHandler = function changeHandler(element) {
      return function () {
    ...
    for (var i = 0; i < feedbackSubmit.length; i++) {
